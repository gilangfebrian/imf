...
class UserController extends BaseController
{
    ...
    {   
        $diklat = DB::table('d_trainings')->orderBy('diklat', 'asc')->lists('diklat','diklat');
        return View::make('users.create')->with('diklat',$diklat);
    }
    ...
    public function regist(){
        ...
        'id_trainings' => Input::get('training'),
        'nama' => Input::get('nama'),
        'nip' => Input::get('nip'),
        'instansi' => Input::get('instansi'),
        'unit2' => Input::get('unit2'),
        'unit3' => Input::get('unit3'),
        'unit4' => Input::get('unit4'),
        'phone' => Input::get('phone'),
        'email' => Input::get('email'),
        'status' => 'selesai',
        );
        
        DB::table('d_trainee') ->insert($data);
        
        return Redirect::to('regist')->with('message','Berhasil melakukan input data peserta');
